...
A VK digest is generated by building the ELF file. It could be generated by using [pico-proving-service gen-app-id](https://github.com/brevis-network/pico-proving-service?tab=readme-ov-file#generate-application-id-locally):
```
